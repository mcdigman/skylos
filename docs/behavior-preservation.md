...
The shared `compare_source_changes` service compares prepared `SourceSnapshot`
inputs within a `ComparisonScope`. The Git adapter calls that service; Git loading,
