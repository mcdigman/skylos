...
const RULES: Record<string, RuleMeta> = {
  ...
  "SKY-A106": { name: "Suspicious dependency version bump", severity: "LOW", category: "ai", description: "A dependency version change exactly matches the project's own version change.", fix: "Check that the dependency change was intentional and not part of a global version replacement.", language: "python" },
